<div class="main-teacher px-3">
    <div class="title pb-3"> Main Teachers</div>
    <div class="teacher-infor d-flex flex-row pb-3">
        <div class="ava col-3">
            <img src="{{ asset('storage/ava_users/ava.png') }}">
        </div>
        <div class="infor col-6">
            <div class="name">Luu Trung Nghia</div>
            <div class="name-intro">Second Year Teacher </div>
            <div class="soical">
                <img class="p-1" src="{{ asset('storage/images/google.png') }}">
                <img class="p-1" src="{{ asset('storage/images/facebook.png') }}">
                <img class="p-1" src="{{ asset('storage/images/slack.png') }}">
            </div>
        </div>
    </div>
