<footer class="d-flex flex-column">
    <div class="div-content-grey d-flex flex-md-nowrap flex-wrap justify-content-md-around pt-md-5 pt-3 pb-5 pl-md-0 pl-2 px-xl-5">
        ...
        <div class="col-md-4 col-12 order-md-1 order-0 d-flex justify-content-center pl-md-5 pr-md-0">
            <ul class="col-xl-5 col-6 ml-xl-5 pl-xl-5 mb-0 px-md-0">
                <li class="mt-3 mt-md-0">
                    <a class="text big" href="#">Home</a>
                </li>
                <li class="my-4">
                    <a class="text" href="#">Features</a>
                </li>
                <li>
                    <a class="text" href="#">Courses</a>
                </li>
                <li class="mt-4 mb-md-0 mb-5">
                    <a class="text" href="#">Blog</a>
                </li>
            </ul>
            <ul class="col-xl-5 col-6 mb-0 px-md-0">
                <li class="mt-3 mt-md-0">
        ...
        <div class="col-md-4 col-5 d-flex order-2 justify-content-center align-items-md-center mt-md-0 mt-n3 pl-md-3 pl-0">
    ...
    <div class="d-flex justify-content-center div-content-back text small p-md-1 p-2">
